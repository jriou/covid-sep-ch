...
# Same stratified by period ----


## setup data
tmp_fit = adjusted_model_predictions_strat %>%
...
ggsave( file="figures/suppfigure_model_fit_stratified_by_period_8june.png",width=25,height=30,units = "cm")
